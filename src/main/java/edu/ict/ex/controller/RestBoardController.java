...
// RestController란 기존의 controller의 속성하고는 판이하게 다름
...
public class RestBoardController {
	...
	public String content(@PathVariable int id, @PathVariable String product) {
		...
		return "<h1>" + "상품 번호는 " + id + product + "<h1>";
	}
	...
	/*
	 * // /boards/ // @RequestBody : json을 자바 객체로 변환
	 * 
	 * @PostMapping("/") // 경로 변수 public String write(@RequestBody BoardVO board) {
	 * log.info("write.."); log.info("board" + board);
	 * 
	 * String words = "SUCCESS";
	 * 
	 * try { boardService.write(board); }
	 * 
	 * catch (Exception e) { e.printStackTrace(); words = "FAIL"; }
	 * 
	 * return words; }
	 */
